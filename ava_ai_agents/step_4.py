...
# -------------------------------------------------------------------
def step_4(ai_model, agent_file_path):
    '''
    Description:
        Create a new agent profile picture
    ...
    Example:
        ...
        step_4(ai_model, agent_file_path)
    '''
    ...
    # step 1.2: load the agent yaml file
    type = TemplateType.PROFILE_PICTURE

    # step 1.3: Generate a new agent name, topic, personality, and communication style with the prompt_1 template
